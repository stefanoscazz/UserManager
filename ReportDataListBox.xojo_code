...
Implements Reports.Dataset
	...
	#tag Method, Flags = &h0
		Function Field(idx as Integer) As Variant
		  ...
		  Case 1
		    Return Field("FieldNome")
		  Case 2
		    Return Field("FieldCognome")
		  Case 3
		    Return Field("FieldCap")
		  Case 4
		    Return Field("FieldEmail")
		  Case 5
		    Return Field("FieldVia")
		  Case 6
		    Return Field("FieldDataDiNascita")
		  Else
		    Return ""
		  End Select
		End Function
	...
	#tag Method, Flags = &h0
		Function Field(name As String) As Variant
		  ...
		  Select Case name
		  Case "FieldId"
		    Return Self.CellValueAt(mRow, 0)
		  Case "FieldNome"
		    Return Self.CellValueAt(mRow, 1)
		  Case "FieldCognome"
		    Return Self.CellValueAt(mRow, 2)
		  Case "FieldCap"
		    Return Self.CellValueAt(mRow, 3)
		  Case "FieldEmail"
		    Return Self.CellValueAt(mRow, 6)
		  Case "FieldVia"
		    Return Self.CellValueAt(mRow, 4)
		  Case "FieldDataDiNascita"
		    Return Self.CellValueAt(mRow, 5)
		  Else
		    Return ""
		  End Select
	...
	#tag Method, Flags = &h0
		Function Type(fieldNome as String) As Integer
		  // Part of the Reports.Dataset interface.
